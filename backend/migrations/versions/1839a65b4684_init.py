...
def upgrade() -> None:
    ...
    op.create_index('idx_user_recorded_at', 'gps_logs', ['user_id', 'recorded_at'], unique=False)
    ...
    op.create_index(op.f('ix_blogs_target_date'), 'blogs', ['target_date'], unique=False)
