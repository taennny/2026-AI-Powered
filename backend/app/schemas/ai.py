...
> docker compose exec backend cat app/services/ai.py
import logging
import math
import uuid
...
PS C:\Users\2023user\OneDrive\Desktop\전공\3학년\상상기업 Roame\2026-AI-Powered\backend> docker compose exec backend cat app/schemas/ai.py
from datetime import datetime
